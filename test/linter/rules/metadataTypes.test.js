...
const {
    ...
    getReturnTypeLabels,
    getParamTypeLabels,
} = require('@/lang/lint/rules/metadataTypes');
const { inferLiteralType, checkAssignmentTypeConsistency } = require('@/lang/lint/rules/typeCheck');
...
suite('BML Linter Test Suite - metadata sidecar type validation', () => {
    ...
    test('readLocalMetadata handles invalid file paths gracefully', () => {
        const { readLocalMetadata } = require('@/lang/lint/rules/metadataTypes');
