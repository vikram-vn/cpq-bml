...
const sourcePath = path.join(__dirname, 'beautify', 'bml_comprehensive_features.bml');
const expectedPath = path.join(__dirname, 'beautify', 'bml_comprehensive_features.expected.bml');
