...
const { registerTestController } = require("./app/lang/test-controller/bmlTestController");
const { registerSchemaIntrospector } = require("./app/lang/intellisense/schemaIntrospector");
const { getCoverageDecorator } = require("./app/lang/test-controller/coverageDecorator");
...
const { registerRemoteTestCommands } = require("./app/lang/test-controller/remoteTestRunner");
