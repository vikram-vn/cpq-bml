...
""",
  ...
  <rect x="1.0" y="1.2" width="14.0" height="2.4" rx="1.2" fill="url(#cfRim)" stroke="#1e293b" stroke-width="0.5"/>
  <line x1="2.4" y1="1.8" x2="13.6" y2="1.8" stroke="#ffffff" stroke-width="0.6" stroke-linecap="round" opacity="0.6"/>
  <path d="M2.0 3.6H14.0L9.8 9.0V14.5C9.8 14.8 9.5 15.0 9.2 15.0H6.8C6.5 15.0 6.2 14.8 6.2 14.5V9.0L2.0 3.6Z" fill="url(#cfBody)" stroke="#1e293b" stroke-width="0.5" stroke-linejoin="round"/>
