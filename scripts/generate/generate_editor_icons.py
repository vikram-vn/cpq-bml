...
Generates the dedicated editor toolbar and command icons in app/icons/editor/:
- validate.svg, save.svg, pull.svg, debug.svg, debug-configure.svg
- deploy.svg, deploy-commerce.svg, deploy-mass.svg, clear.svg
- create-override.svg, remove-override.svg, create-bml.svg, change-env.svg
- settings.svg (SOLID 8-tooth gear), beautify.svg, ai-setup.svg
- metrics.svg, preview.svg, run-tests.svg, snapshot-compare.svg
- snapshot-update.svg, switch-file.svg

Also updates root app/icons/settings.svg to the solid gear format.
"""
import os

PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
EDITOR_ICONS_DIR = os.path.join(PROJECT_ROOT, 'app', 'icons', 'editor')
ROOT_ICONS_DIR = os.path.join(PROJECT_ROOT, 'app', 'icons')
...
""",
  ...
  # SOLID 8-tooth gear with vibrant colorful gradient
...
def main():
    ...
    os.makedirs(ROOT_ICONS_DIR, exist_ok=True)
    
    # 1. Write all editor icons to app/icons/editor/
