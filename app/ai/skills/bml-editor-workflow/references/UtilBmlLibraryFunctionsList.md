...
description: "Util BML Library Functions List (Redwood) Overview The BML Function Library enables the user to write efficient and reusable custom BML functions. The user can write and store BML functions in a centr..."
...
| 2    | Import BML function(s). Refer to [Bulk Uploads](Bulk_Uploads.md).                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 3    | Create a new BML function. Refer to [BML Function Editor](BML_Editor.md).                                                                                                                                                                                                                                                                                                                                                                                                           |
