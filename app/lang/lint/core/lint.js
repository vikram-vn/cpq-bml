...
const { checkAssignmentInCondition } = require('@/lang/lint/rules/assignment');
const { checkOperators } = require('@/lang/lint/rules/operators');
const { checkPerformance } = require('@/lang/lint/rules/performance');
const { checkBestPractices } = require('@/lang/lint/categories/best-practices');
const { checkStyle } = require('@/lang/lint/rules/style');
const { checkBoundaries } = require('@/lang/lint/core/boundaries');
const { checkFunctionCalls } = require('@/lang/lint/rules/functions');
const { checkSystemVariables } = require('@/lang/lint/rules/systemVariables');
const { checkAssignmentTypeConsistency, collectVariableTypesAndMismatches, inferLiteralType } = require('@/lang/lint/rules/typeCheck');
const { checkMetadataTypeConsistency, getDeclaredParameterTypes } = require('@/lang/lint/rules/metadataTypes');
const { checkConstantConditions } = require('@/lang/lint/rules/constantConditions');
const { checkUnreachableCode } = require('@/lang/lint/rules/unreachable');
const { checkDuplicateConditionBranches, parseConditionalChains } = require('@/lang/lint/rules/duplicateBranches');
const { checkMixedOperators } = require('@/lang/lint/rules/mixedOperators');
const { checkLonelyIf } = require('@/lang/lint/rules/lonelyIf');
const { checkUnusedExpressions } = require('@/lang/lint/rules/unusedExpressions');
const { checkUseBeforeDefine } = require('@/lang/lint/rules/useBeforeDefine');
const { getStringRanges, checkUnclosedStrings } = require('@/lang/lint/rules/strings');
const { computeSuppressions } = require('@/lang/lint/core/suppressions');
const { checkSpelling, isCodeSpellCheckerInstalled } = require('@/lang/spell-check/spelling');
const { checkNullSafety } = require('@/lang/lint/rules/nullSafety');
