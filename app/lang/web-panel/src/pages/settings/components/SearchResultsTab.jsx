...
export const ALL_SETTINGS_REGISTRY = [
    ...
    { id: 'showResultsOnly', tab: 'advanced', tabName: 'Advanced', label: 'Show Debug Results Only (Smart)', desc: 'Display only clean output and print statements in the results terminal without headers or verbose timing', type: 'switch', key: 'debug.showResultsOnly' },
