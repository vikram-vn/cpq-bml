...
description: "Conditional Functions Functions Conditional functions are commands that run only when specified criteria is met. Each conditional statement requires a..."
...
Example:if(attr1 == 100){return true;} elif (attr1 == 200){return false;}
