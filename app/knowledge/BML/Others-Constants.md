...
description: "Other Functions CPQ Constants BM_CM_RULES_LOCATION Dictionary key for the rule's message location. Where the message will be displayed. Options are attribute (default) and top. BM_CM_RULES_MESSAGE Dic..."
