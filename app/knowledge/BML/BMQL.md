...
title: "BMQL"
sidebar_label: "BMQL"
description: "BMQL Overview Oracle CPQ can query system tables and user-created Data Tables from within BML by using a SQL-like syntax. This functionality has replaced the deprecated gettabledata() and getpartsdata..."
...
> **Return Type:** `Record Set`
 ...
 Example select column 1, column 2, column 3, column 4 SELECT [DISTINCT] custom_field1 from _parts FROM dataBaseObject;
 ...
 Example FROM someUserCreatedTable
...
**Example:**
```bml title="Example"
SELECT [DISTINCT] custom_field1 from _parts FROM dataBaseObject;
```
...
```
 ...
 Example ORDER BY column 1 desc
 ...
 Example results = bmql("delete from table1 where column1 = 'value2'");     for result in results {     deletion_count_integer = get(result, "records_deleted");     }
 ...
 Syntax RecordSet bmql(String sqlQuery [, String Dictionary contextOverride, String Dictionary fieldMap])
 Example results = bmql("insert into table1 (column1, column2) values ('value1', 11),('value2', 22)");     for result in results {     insert_count_integer = get(result, "records_inserted");     records_error_string = get(results, "records_error");     }
 ...
 Syntax RecordSet bmql(String sqlQuery [, String Dictionary contextOverride, String Dictionary fieldMap])
 Example results = bmql("modify table1 set colum1 = 'new_value1', column2 = 'new_value2' where column1 = 'old_value1'");     for result in results {     insert_count_integer = get(result, "records_inserted");     insert_count_integer = get(result, "records_updated");     records_error_string = get(results, "records_error");     }
