...
description: "Date Functions Functions Date functions are often used when evaluating and calculating quotes in Commerce. As an example, they are used to set quote expiration dates. Dates are always strings in Comme..."
...
> **Return Type:** `Date`
 ...
 Example 1: Convert to US Format strtojavadate("02/12/2010", "MM/dd/yyyy")
