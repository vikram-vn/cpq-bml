...
description: "BML Functions List BML functions are listed below are listed alphabetically and display the category link for each function. Function Category Description acos Math Returns the arc-cosine of the numbe..."
