...
**Syntax:**
```bml
containskey(dictIdentifier, key)
```
...
**Syntax:**
```bml
keys(Dictionary dictionaryIdentifier)
```
...
**Example:**
```bml title="Example"
d= dict("string"); put(d, "key1", "string1"); put(d, "key2", "string2"); return values(d);
```
