...
The name of the script author, date,  function editors' names, and summarizing commentsExample:Name                 Date                 Comments------------------John Doe           1/1/19               Created FunctionJane Doe            5/1/19               Added additional managers to notifications
...
Variable names for Arrays should have the "List", "Arr", "Array" and/or "2D" suffixFor example: docNumList, upgradedPartsArray, partsData2DArray
